...
class FacturaController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','facturacion'),
				'users'=>array('@'),
			),
	...
	public function actionFacturacion()
	{
	    ...
	    $model=new Factura('facturacion');

	    // uncomment the following code to enable ajax-based validation
	    /*
	    if(isset($_POST['ajax']) && $_POST['ajax']==='factura-facturacion-form')
	    {
	        echo CActiveForm::validate($model);
	        Yii::app()->end();
	    }
	    */
	    $clientes=Clientes::model()->search();
	    if(isset($_POST['Factura']))
	    {
	        $model->attributes=$_POST['Factura'];
	        if($model->validate())
	    ...
	    $this->render('facturacion',array('model'=>$model,'clientes'=>$clientes));
	
	    
	    if(isset($_GET['id'])){
	    	$varid=$_GET['id'];
	    	$this->renderPartial('prueba',array('varid'=>$varid));
